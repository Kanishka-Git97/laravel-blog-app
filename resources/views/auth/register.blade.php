    ...
    <div class="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0 ">
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            ...
            {!! Form::open(array('route'=>'register.post')) !!}
                ...
                <div>
                    {{ Form::label('password_confirmation', 'Confirm Password', array('class'=>'block mb-2 text-sm font-medium text-gray-900')) }}
                    {{ Form::password('password_confirmation', array('class'=>'bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5', 'required'=>'')) }}
                </div>
